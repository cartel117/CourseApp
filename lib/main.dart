import 'package:course_app/View/SubjectSystemView.dart';
...
void main() async{
 ...
 // 插入預設的課程資料
  ...
  // 檢查是否已經有預設的課程資料
  bool hasDefaultCourses = await DatabaseHelper.instance.hasDefaultCourses();

  if (!hasDefaultCourses) {
    // 如果還沒有預設的課程資料，插入預設課程資料
    print("資料庫沒有預設的資料");
    await DatabaseHelper.instance.insertDefaultCourses();
